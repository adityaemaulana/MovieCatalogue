...
class HomeActivityTest {
    ...
    fun loadDetailMovies() {
        ...
        onView(withId(R.id.text_status_value)).check(matches(isDisplayed()))
        onView(withId(R.id.text_status_value)).check(matches(withText(dummyMovies[0].status)))
    ...
    fun loadDetailShows() {
        ...
        onView(withId(R.id.text_status_value)).check(matches(isDisplayed()))
        onView(withId(R.id.text_status_value)).check(matches(withText(dummyShows[0].status)))
        onView(withId(R.id.text_language_value)).check(matches(isDisplayed()))
