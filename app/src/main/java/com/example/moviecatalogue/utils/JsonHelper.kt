        ...
        try {
            ...
            for (i in 0 until listArray.length()) {
                ...
                val movieResponse = FilmResponse(
                    id, title, rating, releaseDate, language, description, imagePath, null, TYPE_MOVIE
                )
    ...
    fun loadTVShows(jsonString: String): List<FilmResponse> {
        ...
        try {
            ...
            for (i in 0 until listArray.length()) {
                ...
                val movieResponse = FilmResponse(
                    id, title, rating, releaseDate, language, description, imagePath, null, TYPE_TVSHOW
                )
    ...
    fun loadFilmWithGenres(jsonString: String, type: Int): FilmResponse {
        ...
        try {
            ...
            filmResponse = FilmResponse(
                id, title as String, rating, releaseDate as String, language, description, imagePath, genreResponses, type
            )
